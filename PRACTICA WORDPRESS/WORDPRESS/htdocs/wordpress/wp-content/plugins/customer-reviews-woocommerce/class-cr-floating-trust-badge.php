	...
	class CR_Floating_Trust_Badge {
      ...
      if( 'bottomleft' === $float_location ) {
        ...
        $location_css = "right:0px;";
			...
			$output .= '<a class="cr_floatingtrustbadge_big" href="https://www.cusrev.com/' . $site_lang . 'reviews/' . get_option( 'ivole_reviews_verified_page', Ivole_Email::get_blogdomain() ) . '" rel="nofollow" target="_blank" style="display:none;"><img src="' . $big_src . '"></a>';
			$output .= '</div>';
			echo $output;
		}
	}
